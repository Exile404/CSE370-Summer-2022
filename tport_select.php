...
<!------ Include the above in your HEAD tag ---------->
    ...
    <link rel="stylesheet" href="style3.css?v=0.0.2">

</head>
<body>
    <div class="section_our_solution">
      <form action="./partial/transport.php" method="post">
        <div class="row">
              ...
              <div class="solution_cards_box">
                <div class="solution_card">
                  ...
                  <div class="solu_description">
                    ...
                    <button type="submit" class="read_more_btn" value="BUS" name="ttype">GRAB YOUR TICKETS</button>
                  </div>
                </div>
                <div class="solution_card">
                  <div class="hover_color_bubble"></div>
                  ...
                  <div class="solu_description">
                    ...
                    <button type="submit" class="read_more_btn" value="TRAIN" name="ttype">GRAB YOUR TICKETS</button>
                  </div>
                </div>
              </div>
              <!--  -->
              <div class="solution_cards_box sol_card_top_3">
                <div class="solution_card">
                  ...
                  <div class="solu_description">
                    ...
                    <button type="submit" class="read_more_btn" value="AIR" name="ttype">GRAB YOUR TICKETS</button>
                  </div>
                </div>
